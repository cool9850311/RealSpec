...
/** examples/minimart-go-nuxt/frontend */
export const FRONTEND_DIR = path.resolve(E2E_DIR, '../..')

/**
 * examples/minimart-go-nuxt — the build context both Dockerfiles expect, the
...
export const MIGRATIONS_DIR = path.join(BACKEND_DIR, 'migrations')
...
export const BACKEND_IMAGE = 'minimart-backend:e2e'
export const FRONTEND_IMAGE = 'minimart-frontend:e2e'
 ...
 */
export const JWT_SECRET = 'minimart-e2e-secret'
...
/** Overrides workerCount(). The step runner's GODOG_CONCURRENCY, for browsers. */
