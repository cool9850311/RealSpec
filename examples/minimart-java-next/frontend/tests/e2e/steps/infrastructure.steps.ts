...
// implementation is the Cucumber-JVM runner under backend/src/test/java/minimart/bdd/;
// where the two agree on a detail — the sequence reset below, the row-count
// semantics — they agree on purpose, and a change to one is a change to both.
...
/**
 * The row-count semantics format.yml documents, identical to the Java side:
