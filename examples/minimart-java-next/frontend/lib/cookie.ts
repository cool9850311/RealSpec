...
// authority.
//
// Browser-only. Every function returns a harmless answer during the static
// export's prerender (where there is no `document`) rather than throwing, so a
// caller does not have to repeat the guard.
