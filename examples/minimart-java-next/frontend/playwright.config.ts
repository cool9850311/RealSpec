...
// files, and the Playwright runner runs them against the Spring Boot service and
// the Next.js static export, each scenario on its own stack (tests/e2e/stack.ts).
// The runner is the same one minimart-go-nuxt uses, file for file: the browser
// surface names ARIA roles, test ids, i18n keys and relative URLs, none of which
// know which framework rendered them.
//
...
// ── The projects ─────────────────────────────────────────────────────────────
//
//   spec             the 11 scenarios of spec/bdd/e2e — minimart's own e2e suite
